...
import aroonosc from './index'

export default () => {
  describe('Input', () => {
    it('should throw error with wrong timeperiod param', () => {
      assert.throws(aroonosc.bind(null, [Big(1)], [Big(0)], null), Error, 'Timeperiod should be an instance of Big or string!')
    })
    it('should throw error with wrong values', () => {
      assert.throws(aroonosc.bind(null, [Big(1)], [null], '12'), Error, 'Input value should be an instance of Big or NaN!')
      assert.throws(aroonosc.bind(null, [null], [Big(1)], '12'), Error, 'Input value should be an instance of Big or NaN!')
    })
  })
  describe('Output', () => {
    let input = {
    ...
    let output = ['NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', 'NaN', '75.00', '79.17', '83.33', '83.33', '91.67', '91.67', '87.50', '95.83', '91.67', '95.83', '83.33', '83.33', '83.33', '58.33', '58.33', '58.33', '58.33', '58.33', '58.33', '54.17', '-45.83', '-50.00', '-54.17', '-58.33', '-62.50', '-62.50', '-62.50', '-62.50', '-62.50', '-62.50', '-62.50', '-62.50', '-62.50', '37.50', '41.67', '41.67', '50.00', '50.00', '58.33', '62.50', '62.50', '62.50', '62.50', '62.50', '62.50', '62.50', '62.50', '62.50', '58.33', '54.17', '50.00', '-16.67', '-16.67', '-16.67', '45.83', '50.00', '54.17', '58.33', '58.33', '58.33', '58.33', '58.33', '58.33', '58.33', '58.33', '58.33', '58.33', '37.50', '37.50', '37.50', '37.50', '37.50', '33.33', '29.17', '-70.83', '-75.00', '-79.17', '-83.33', '-87.50', '-91.67', '-95.83', '-54.17', '-54.17', '-54.17', '-54.17', '-54.17', '-54.17', '-54.17', '-54.17', '-54.17', '-54.17', '-50.00', '-45.83', '-41.67', '-37.50', '-33.33', '-25.00', '-25.00', '-20.83', '-16.67', '-12.50', '70.83', '70.83', '70.83', '66.67', '62.50', '37.50', '37.50', '37.50', '37.50', '37.50', '-58.33', '-58.33', '-58.33', '-58.33', '-58.33', '-58.33', '-58.33', '-58.33', '-91.67', '-91.67', '-41.67', '-41.67', '-41.67', '-41.67', '25.00', '25.00', '33.33', '33.33', '41.67', '41.67', '41.67', '54.17', '58.33', '58.33', '58.33', '70.83', '70.83', '70.83', '70.83', '70.83', '70.83', '70.83', '66.67', '62.50', '58.33', '54.17', '29.17', '29.17', '29.17', '29.17']
    Object.keys(input).forEach(key => {
      input[key] = input[key].map(Big)
    })

    let result = aroonosc(input['high'], input['low'], '24')
